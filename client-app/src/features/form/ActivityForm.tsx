...
export default function ActivityForm({ activity: selectedActivity, closeForm, saveActivity, submitting }: Props) {
    ...
    return (
        <Segment clearing>
            <Form onSubmit={onFormSubmit_Listener} autoComplete='off'>
                ...
                <Form.Input type='date' placeholder='Date' value={activity.date} name='date' onChange={onFormInputsChange_Listerner} ></Form.Input>
